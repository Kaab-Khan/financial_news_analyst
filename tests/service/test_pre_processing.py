...
from src.service.pre_processing import is_trusted_source, filtered_articles, filter_ohlcv_by_range
...
def test_format_av_time_series_data():
    ...
    assert isinstance(formatted_data[0]["date"], str)
...
def test_filter_ohlcv_by_range():
    ...
    # Test data
    data = [
        {"date": "2025-09-28", "open": 150.0, "high": 155.0, "low": 149.0, "close": 154.0, "adjusted_close": 154.0, "volume": 1000000},
        {"date": "2025-09-27", "open": 151.0, "high": 156.0, "low": 150.0, "close": 155.0, "adjusted_close": 155.0, "volume": 2000000},
        {"date": "2025-09-26", "open": 152.0, "high": 157.0, "low": 151.0, "close": 156.0, "adjusted_close": 156.0, "volume": 3000000},
        {"date": "2025-09-25", "open": 153.0, "high": 158.0, "low": 152.0, "close": 157.0, "adjusted_close": 157.0, "volume": 4000000},
        {"date": "2025-09-24", "open": 154.0, "high": 159.0, "low": 153.0, "close": 158.0, "adjusted_close": 158.0, "volume": 5000000},
        {"date": "2025-09-23", "open": 155.0, "high": 160.0, "low": 154.0, "close": 159.0, "adjusted_close": 159.0, "volume": 6000000},
        {"date": "2025-09-22", "open": 156.0, "high": 161.0, "low": 155.0, "close": 160.0, "adjusted_close": 160.0, "volume": 7000000},
        {"date": "2025-09-21", "open": 157.0, "high": 162.0, "low": 156.0, "close": 161.0, "adjusted_close": 161.0, "volume": 8000000},
        {"date": "2025-09-20", "open": 158.0, "high": 163.0, "low": 157.0, "close": 162.0, "adjusted_close": 162.0, "volume": 9000000},
        {"date": "2025-09-19", "open": 159.0, "high": 164.0, "low": 158.0, "close": 163.0, "adjusted_close": 163.0, "volume": 10000000},
    ]
    ...
    end_date = "2025-09-27"
    expected_output = [
        {"date": "2025-09-27", "open": 151.0, "high": 156.0, "low": 150.0, "close": 155.0, "adjusted_close": 155.0,
            "volume": 2000000},
    ]
    assert filter_ohlcv_by_range(data, start_date, end_date) == expected_output
