...
ALPHA_VINTAGE_API_KEY = os.getenv("ALPHA_VINTAGE_API_KEY","NTEFUDMBWULTAI47")  # Replace with a default for testing
ALPHA_VINTAGE_API_URL = os.getenv("ALPHA_VINTAGE_API_URL", "https://www.alphavantage.co/query?")
